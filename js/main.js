...
function initWishes() {
    ...
    if (wishForm) {
        const scriptURL = "https://script.google.com/macros/s/AKfycbxnvHiEVaNKQtJUUrM6v_BgDniAfPNBfpS1vxMbwW37EjQbOiVuY1mTsatugfZMXxp1/exec"; // paste the web app URL here
